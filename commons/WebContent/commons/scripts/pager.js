	...
	switch (this.lang) {
		case "cn":
			...
			if (this.currentPage == 1 || pageCount <= 1) {
				pagerStrings[pagerStrings.length] = '<span style="color:#999;"> \u9996\u9875 \u4e0a\u4e00\u9875 </span>';
			} else {
			...
			if (this.currentPage == pageCount || pageCount <= 1) {
				pagerStrings[pagerStrings.length] = '<span style="color:#999;"> \u4e0b\u4e00\u9875 \u5c3e\u9875</span>';
			} else {
			...
			pagerStrings[pagerStrings.length] = ' \u7b2c <input style="text-align:center;border: 1px solid #CCCCCC;width:36px;" name="pager.requestPage" type="text" id="requestPage" size="2" maxlength="6" value="' + this.currentPage + '" onchange="this.value = isInteger(this.value) ? this.value : 1" /> \u9875 ';
			pagerStrings[pagerStrings.length] = '<input name="buttonsubmitPage" type="submit" class="bot" id="buttonsubmitPage" value="\u8f6c\u5230" onclick="this.form.requestPage.value = isInteger(this.form.requestPage.value) ? this.form.requestPage.value : 1" />';
			break;
	}
